...
router.get("/storage/objects/*path", requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    // ACL check: find the message that owns this attachment and verify room membership
    const userId = req.user!.userId;
    const userRole = req.user!.role;

    if (userRole !== "admin") {
      // Use server-issued upload grant to authorize access (not URL-string matching on messages)
